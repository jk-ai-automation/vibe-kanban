...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::admin::users::AdminUserInfo::decl(),
        server::routes::admin::users::ListLocalUsersResponse::decl(),
        server::routes::admin::users::CreateLocalUserRequest::decl(),
        server::routes::admin::users::UpdateLocalUserRequest::decl(),
        server::routes::admin::users::AdminResetPasswordRequest::decl(),
        server::routes::admin::invites::LocalInviteInfo::decl(),
